...
const manyProblemsContent  = document.querySelector('.manyProblems-Content div');
...
function darkmode() {
  ...
  if(toggle.classList.toggle('bi-moon')){
      ...
      manyProblemsContent.style.background = "rgba(0, 0, 0, 0.85)" ;
      ...
      aboutme.style.background = '#323946';
      aboutme.style.transition = '2s';
      ...
      manyProblemsContent.style.background = "#1f23d" ;
...
var newUpdateLocal = localStorage.getItem("Update13")
...
let NewMessage = [
  {
      id: 1 ,
      icon: "bx bxs-cog" ,
      heading: "The New Update 13" ,
      iconheading: "🌟🚀" ,
      time: "In 13/3/2024",
      desc: "what's new ? <br/><br/> * Added A Page For Goals OF All Years Like 2024 , 2023 , 2022 <br/> * 4 Quotes Is Added <br/> * The Website has been Faster <br/> * More Improvements" ,
      btnContent: "OK",
  },
];
...
SendUpdate.addEventListener('click' , function() {
  localStorage.setItem("Update13" , JSON.stringify("Updated"));

  var itemsToRemove = ["Update8" , "Update9" , "Update10" , "Update11" , "Update12" ];
